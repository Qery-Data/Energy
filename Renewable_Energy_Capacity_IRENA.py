...
net_additions_regions_df.to_csv("data_IRENA/IRENA_Total_Renewable_Capacity_Regions_Net_Additions.csv")
...
share_regions_df.to_csv("data_IRENA/IRENA_Total_Renewable_Capacity_Regions_Share_Per_Year.csv")