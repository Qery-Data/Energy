...
# Fetch data from IRENA API for countries
...
# Replace technology names and combine data
...
def generate_files_for_technology(technology, df_countries):
    ...
    if not pivot_countries_df.empty:
        ...
        net_additions_countries_df = pivot_countries_df.diff(axis=1).drop(columns='2000', errors='ignore').round(2)
...
# List of technologies to process for countries
...
#ADDITIONAL FILES FOR TECHNOLOGIES 
...
# Renewable Energy Share of Electric Generation Countries
