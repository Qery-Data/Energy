...
import pandas as pd
os.makedirs('data_IRENA_Renewable_Generation', exist_ok=True)

#Data Gathering from IRENA API Renewable Energy Generation
url = 'https://pxweb.irena.org:443/api/v1/en/IRENASTAT/Power Capacity and Generation/REGEN_2023_cycle2.px'
query = {
     "query": [
            {
            "code": "Technology",
...
def generate_files_for_technology(technology, df, regions=['Africa', 'Asia', 'Central America and the Caribbean', 'Eurasia', 'Europe', 'Middle East', 'Oceania', 'South America', 'North America']):
    # Filename prefix
    filename_prefix = "data_IRENA_Renewable_Generation/IRENA_" + technology.title().replace(" ", "_") + "_Generation"
    ...
    latest_year_net_additions['Percentage Change'] = (latest_year_net_additions[latest_year] / pivot_countries_df[latest_year]) * 100
...
# Total Renewable Energy Generation World Per Technology
...
pivot_tech_df.to_csv("data_IRENA_Renewable_Generation/IRENA_Total_Renewable_Energy_Generation_Per_Technology.csv")

# Total Renewable Energy Net Generation Additions World Per Technology
...
net_additions_tech_df.to_csv("data_IRENA_Renewable_Generation/IRENA_Total_Renewable_Energy_Generation_Per_Technology_Net_Additions.csv")

# Total Wind Sub-Technologies Generation World Per Technology
...
pivot_wind_subtech_df.to_csv("data_IRENA_Renewable_Generation/IRENA_Wind_Sub_Technologies_Generation_Per_Technology.csv")

# Total Wind Sub-Technologies Net Generation Additions World Per Technology
...
net_additions_wind_subtech_df.to_csv("data_IRENA_Renewable_Generation/IRENA_Wind_Sub_Technologies_Generation_Per_Technology_Net_Additions.csv")


#ADDITIONAL FILES FOR RENEWABLE ENERGY SHARES OF TOTAL GENERATION
...
# Renewable Energy Share of Electric Generation World
...
pivot_world_df.to_csv("data_IRENA_Renewable_Generation/IRENA_Renewable_Share_Electric_Generation_World.csv")

# Renewable Energy Share of Electric Generation Regions
...
pivot_regions_df.to_csv("data_IRENA_Renewable_Generation/IRENA_Renewable_Share_Electric_Generation_Regions.csv")

# Total Renewable Energy Generation Countries
excluded_entities = regions + ['World', 'European Union']
